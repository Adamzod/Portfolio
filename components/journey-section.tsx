...
const experiences = [
  ...
  },
  {
    ...
    description:
      "Built a full-stack scheduling and billing platform for a tutoring company, supporting 50 tutors and 400+ students with real-time automation and secure data management.",
    details: [
      "Developed a robust platform using Node.js, GraphQL, React, and MongoDB, enabling seamless scheduling and billing for tutors and students.",
      "Automated scheduling workflows and real-time notifications with WebSockets, saving 30+ hours per week and reducing billing errors by 40 per month.",
      "Implemented secure, role-based authentication with JWT and OAuth, protecting sensitive tutor and student data.",
      "Designed and integrated a dynamic calendar interface for tutors and students, streamlining session booking and reducing scheduling conflicts.",
      "Built analytics dashboards for administrators to monitor tutor utilization, student engagement, and revenue trends.",
      "Optimized database queries and API endpoints, improving response times and supporting concurrent usage during peak scheduling periods.",
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Developed an e-commerce system with Django + PostgreSQL, managing 50+ products and generating $25K–$40K yearly sales.",
    details: [
      ...
      "Integrated secure user authentication and admin tools, enabling granular access control for staff and customers.",
      "Implemented data analytics features for sales and inventory, empowering business owners to make data-driven decisions.",
      "Refactored legacy codebase and improved test coverage, reducing bugs and streamlining future feature development.",
    ],
  },
  {
